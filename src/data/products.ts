...
export const babyChildrenProducts: Product[] = [
  {
    id: 'baby-sunscreen-1',
    name: 'Baby & Kids SPF 50+ Gentle Sunscreen - Hypoallergenic',
    image: babySunscreenImg,
    originalPrice: 24.99,
    currentPrice: 19.99,
    rating: 4.8,
    reviewCount: 234,
    isFsaEligible: true,
    badges: ['Pediatrician Recommended', 'Tear-Free'],
    category: 'Baby & Children',
    brand: 'Johnson & Johnson',
    patientProfile: ['Infant', 'Child'],
    materials: ['Hypoallergenic', 'Zinc Oxide'],
    conditionsHelped: ['Sun Protection', 'Sensitive Skin'],
    inStock: true,
    freeShipping: true,
    dimensions: { height: '6"', width: '2.5"', weight: '4 oz' }
  },
  {
    id: 'baby-thermometer-1',
    name: 'Digital Baby Thermometer - Forehead & Ear',
    image: thermometerImg,
    originalPrice: 49.99,
    currentPrice: 34.99,
    rating: 4.7,
    ...
    isStaffPick: true,
    isFsaEligible: true,
    badges: ['Fast Reading', 'Memory Function'],
    category: 'Baby & Children',
    brand: 'Braun',
    patientProfile: ['Infant', 'Child'],
    powerFeatures: ['Battery Powered', 'LCD Display'],
    certifications: ['FDA Approved'],
    conditionsHelped: ['Fever Monitoring', 'Health Tracking'],
    inStock: true,
    freeShipping: true
  },
  {
    id: 'pediatric-wheelchair-1',
    name: 'Pediatric Transport Wheelchair - Adjustable & Lightweight',
    image: wheelchairImg,
    originalPrice: 399.99,
    currentPrice: 329.99,
    rating: 4.6,
    reviewCount: 89,
    isFsaEligible: true,
    badges: ['Growth Adjustable', 'Safety Features'],
    category: 'Baby & Children',
    brand: 'Drive Medical',
    patientProfile: ['Child', 'Special Needs'],
    weightCapacity: '125 lbs',
    mobilityFeatures: ['Adjustable Height', 'Safety Straps'],
    materials: ['Aluminum Frame', 'Padded Seat'],
    inStock: true,
    freeShipping: true
  },
  {
    id: 'baby-nebulizer-1',
    name: 'Pediatric Nebulizer Kit with Child-Friendly Masks',
    image: nebulizerImg,
    ...
    reviewCount: 167,
    isFsaEligible: true,
    badges: ['Child-Friendly', 'Quiet Operation'],
    category: 'Baby & Children',
    brand: 'Omron',
    patientProfile: ['Infant', 'Child'],
    powerFeatures: ['AC Powered', 'Quiet Motor'],
    conditionsHelped: ['Asthma', 'Respiratory Issues'],
    inStock: true,
    freeShipping: true
  },
  {
    id: 'baby-safety-kit-1',
    name: 'Complete Baby Safety & Health Kit - First Aid Essentials',
    image: nitrileGlovesImg,
    originalPrice: 59.99,
    currentPrice: 44.99,
    rating: 4.4,
    reviewCount: 312,
    isFsaEligible: true,
    badges: ['Complete Kit', 'Travel Ready'],
    category: 'Baby & Children',
    brand: 'Safety 1st',
    patientProfile: ['Infant', 'Child'],
    materials: ['BPA-Free', 'Non-Toxic'],
    conditionsHelped: ['Emergency Care', 'Daily Care'],
    inStock: true,
    freeShipping: true
  },
  {
    id: 'baby-monitor-1',
    name: 'Smart Baby Health Monitor - Heart Rate & Breathing',
    image: pulseOximeterImg,
    originalPrice: 199.99,
    currentPrice: 149.99,
    rating: 4.3,
    reviewCount: 78,
    isFsaEligible: true,
    badges: ['Smart Technology', 'App Connected'],
    category: 'Baby & Children',
    brand: 'Owlet',
    patientProfile: ['Infant'],
    powerFeatures: ['Rechargeable', 'Wireless'],
    certifications: ['FDA Registered'],
    conditionsHelped: ['Sleep Monitoring', 'Peace of Mind'],
    inStock: true,
    freeShipping: true
  }
];
